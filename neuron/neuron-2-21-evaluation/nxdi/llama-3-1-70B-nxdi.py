# Demo for Llama 3.1 70B instruct model with standalone NxDI.
...
traced_model_path = "/opt/ml/model/test_neuron_vllm/local-models/meta-llama/Llama-3.1-70B-Instruct/neuron-compiled-artifacts/"
